...
const DOMAIN = "http://fidget-spinner-micro-frontends.s3-website-us-east-1.amazonaws.com/server/public";
...
export const cartItems = [
    ...
    },
    {
        ...
        image: `${DOMAIN}/fidget-7.jpg`,
        longDescription: 'This is the solid stainless steel fidget spinner that is perfect for any gold lover. It is build with 6 Fidget Spinner components giving it 6 super-sized bearings for maximum glide and endless spin time. A perfect combination of gold, steel & infinity.',
    },
    {
        id: 8,
    ...
    },
    {
        ...
        price: 12.99,
        description: 'So many gears and so little time. You will be endlessly fascinated by this spinner.',
        image: `${DOMAIN}/fidget-11.jpg`,
        longDescription: "Did you know that a standard gear train has 3 gears? It is true! And, we've given you all three in this delightful fidget spinner. Spin away and watch your mind be blown away by the seemingly endless and rapid movement of these three little clockwork wheels.",
    },
];
...
export const addToCart = (id) => {
    ...
    new Promise((resolve, reject) => {
        ...
        const cartItem = currentCart.find((cartItem) => cartItem.id === parseInt(id));
        if (cartItem) {
            const cartItemIndex = currentCart.findIndex((cartItem) => cartItem.id === parseInt(id));
        ...
        cart.next({ cartItems: currentCart });
        resolve(currentCart);
    });
};
...
export const generateCart = () => {
    ...
    let selected = shuffled.slice(0, Math.random() * ((cartItems.length/2) - 1) + 1);
    selected.map((item) => {
        item.quantity = 1;
        return item
    });
    currentCart = selected;
    return selected;
};
